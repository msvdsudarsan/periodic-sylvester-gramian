...
%% run_all_examples.m
%
% Runs all examples and demonstrations for the periodic Gramian paper
%
...
%RUN_ALL_EXAMPLES Execute all examples and demonstrations for the
periodic Gramian paper

% This script runs all the examples and tests described in the research
paper:

% "Controllability and Efficient Gramian Computation for Periodic
Sylvester Matrix Systems"
...
fprintf(' • K(t) = 0.079 * [1+0.2*cos(t); 0.5*sin(t)] (correct
scaling)\n');
...
W_benchmark = compute_periodic_gramian_block(A_func, B_func, K_func,
2*pi, 101);
