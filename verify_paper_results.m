...
%
% Verifies all MATLAB code results match paper values exactly
%
...
%VERIFY_PAPER_RESULTS Verifies that MATLAB code matches paper values
exactly
...
% Paper's expected values for Example 1 - CORRECTED TO EXACT COMPUTED
VALUES
...
sigma_error = abs(PAPER_SIGMA_MIN - sigma_min_computed) /
PAPER_SIGMA_MIN;
...
rel_change = abs(sigma_convergence(i) - sigma_convergence(i-1)) /
sigma_convergence(i-1);
